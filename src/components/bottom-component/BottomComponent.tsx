...
export const BottomComponent = () => {
  ...
  const dataTemplate = (data: any) => {
    return (
      <div
        className="border-1 surface-border m-2 text-center"
  ...
  return (
    <div className="m-8" style={{ paddingTop: "2rem" }}>
